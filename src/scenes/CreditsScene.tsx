...
export default function CreditsScene() {
    ...
    return (
        <div className="credits">
            ...
            <ul>
                <li><b>Mathis Grange</b>, <b>Clara Poirier</b>, <b>Pénélope Douet</b>, <b>Mattéo Decorsaire</b> and <b>Éloïse Poitou</b>, <b>Thibault Bustarret</b> did most of the level design.</li>
